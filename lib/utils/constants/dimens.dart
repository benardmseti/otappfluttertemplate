...
/// Centralized way to manage dimensions e.g. Paddings, elevation, gradients etc.
///
/// Handles different screen sizes too.
abstract final class Dimens {
  ...
  // General elevation used to elevate UI items
  static const elevation = 7.0;

  // General card width
  static const payCardWidth = 80.0;
